...
test("evaluates all unique station-to-park routes and injects real minutes", async () => {
  let calls = 0;
  ...
  const source = new LiveRouteRecommendationDataSource(new FakeRecommendationDataSource(), routes);
  const participants = [
    { id: "p1", alias: "민지", stationId: "hongdae" },
    { id: "p2", alias: "준호", stationId: "gangnam" },
    { id: "p3", alias: "민지2", stationId: "hongdae" },
  ];
