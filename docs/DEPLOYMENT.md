...
3. 카카오톡 나와의 채팅으로 초대한 뒤 장소를 제출하고 카카오 인앱브라우저 또는 외부 Chrome 창을 완전히 닫는다. 같은 초대장을 다시 열었을 때 브라우저 저장소의 약속별 복구 키로 입력폼 대신 추천 결과 또는 제출 완료 대기 상태가 복원되고 HttpOnly 쿠키가 다시 발급되는지 확인한다.
