import type { CandidateInput } from "@hangang-compass/domain";
...
export function fakeCandidates(
  participants: Array<{ id: string; stationId: string }>,
): CandidateInput[] {
...
export function meetingPointFor(parkId: string): string {
